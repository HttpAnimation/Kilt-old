...
distdir: FORCE
	...
	$(COPY_FILE) --parents kiltide.h $(DISTDIR)/
	$(COPY_FILE) --parents Kilt.cpp kiltide.cpp $(DISTDIR)/
...
Kilt.o: Kilt.cpp kiltide.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o Kilt.o Kilt.cpp

kiltide.o: kiltide.cpp kiltide.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o kiltide.o kiltide.cpp

moc_kiltide.o: moc_kiltide.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o moc_kiltide.o moc_kiltide.cpp
